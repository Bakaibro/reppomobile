package com.example.bakai_furniture.ui.description;
...
import com.example.bakai_furniture.R;
import com.example.bakai_furniture.databinding.FragmentDescriptionBinding;
import com.example.bakai_furniture.databinding.ItemDescCardBinding;
import com.example.bakai_furniture.models.FurnitureModel;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (d_list!= null) {
            ...
            Toast.makeText(requireActivity(),
                    "Вы не выбрал", Toast.LENGTH_SHORT).show();
        }
